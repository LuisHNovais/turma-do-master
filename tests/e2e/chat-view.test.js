...
test.describe('Chat View — Batch 4', () => {
  ...
  test('message bubbles have correct background colors', async ({ page }) => {
    ...
    // --WDS-systems-bubble-surface-outgoing: #dff5ff = rgb(223, 245, 255)
    expect(outBg).toBe('rgb(223, 245, 255)');
    ...
    if (await incoming.count() > 0) {
      ...
      // --WDS-systems-bubble-surface-incoming: #fffdf3 = rgb(255, 253, 243)
      expect(inBg).toBe('rgb(255, 253, 243)');
    }
  });
