...
import { BRAND_LOGO, BRAND_NAME, BRAND_SITE, EXPORT_PREFIX } from './brand.js';
...
const ATTRIBUTION_URL = BRAND_SITE;
const ATTRIBUTION_NAME = BRAND_NAME;
const ATTRIBUTION_LOGO = BRAND_LOGO;
...
export function screenshotFilename(conversationName) {
  ...
  return `${EXPORT_PREFIX}-${slug || 'conversa'}.png`;
}
