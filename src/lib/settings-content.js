/**
 * Settings/About content for the A Turma do Master about drawer.
 *
  ...
  sections: [
    {
      ...
      paragraphs: [
        { text: 'A Turma do Master é um visualizador das conversas extraídas dos celulares apreendidos de Daniel Vorcaro, ex-dono do Banco Master, na Operação Compliance Zero. São 66.387 mensagens em 24 conversas, de dezembro de 2023 a novembro de 2025 — navegáveis, pesquisáveis e compartilháveis.' },
        { text: 'A interface organiza os envolvidos como uma turma de personagens do caso: cada contato tem foto ou avatar, perfil próprio, contexto e os trechos que explicam seu papel. O visual usa linguagem original de gibi brasileiro — cores vivas, contornos grossos, balões e cards arredondados — sem reproduzir marcas, personagens ou artes de terceiros.' },
