 ...
 * index — see scripts/split-data.mjs.
 */
  ...
  'thiago-miranda-leo-dias': {
    ...
    sections: [{
      ...
      paragraphs: [
        ...
        { text: 'Na IPJ-A nº 276/2026, o mesmo chat aparece em outro contexto: monitoramento e tentativa de neutralização de jornalistas. Vorcaro escreve que precisava "{frear a malu gaspar}[action:search@thiago-miranda-leo-dias:frear a malu gaspar]"; Thiago responde que iria "{revirar a vida dela}[action:search@thiago-miranda-leo-dias:revirar a vida dela]", depois diz que precisava "{calar essa mulher}[action:search@thiago-miranda-leo-dias:calar essa mulher]" e encaminha dados financeiros, endereços e a proposta "{Carta Proposta Malu Gaspar}[action:search@thiago-miranda-leo-dias:Carta Proposta Malu Gaspar]". O relatório também cita o dossiê "{Família Maluhy}[action:search@thiago-miranda-leo-dias:Família Maluhy]" e contatos com Consuelo Dieguez e Renato Breia para pressionar edição ou retirada de publicações.' },
      ],
    }],
  },
