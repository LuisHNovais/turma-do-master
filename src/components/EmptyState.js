...
import { BRAND_LOGO, BRAND_NAME } from '../lib/brand.js';
...
export function renderEmptyState(container) {
  ...
  el.innerHTML = `
    <img
      ...
      aria-hidden="true"
    />
    <h1 class="empty-state-title">${BRAND_NAME}</h1>
    <p class="empty-state-text">
      Uma roda de conversas vazadas do Daniel Vorcaro.<br>
      Escolha um personagem da turma para começar.
    </p>
