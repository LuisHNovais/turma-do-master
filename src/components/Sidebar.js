 ...
 */
export function renderSidebar(container, { conversations, onSelect, onProfile, onAbout, onExportAll, onCalls, onChats, onGame, readConversations = new Set() }) {
  ...
  el.innerHTML = `
    <div class="sidebar-header">
      <span class="sidebar-header-title">${BRAND_NAME}</span>
  ...
  bottomNav.innerHTML = `
    ...
    <button class="sidebar-bottom-tab" data-tab="game">
      <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 11h10a5 5 0 0 1 4.7 3.3l.6 1.8a2.8 2.8 0 0 1-4.7 2.8L15.3 16H8.7l-2.3 2.9a2.8 2.8 0 0 1-4.7-2.8l.6-1.8A5 5 0 0 1 7 11Z"/><path d="M8 9V6"/><path d="M16 9V6"/><path d="M8 14h.01"/><path d="M11 14h.01"/><path d="M16 14h.01"/></svg>
      <span>Jogo</span>
    </button>
  `;
  ...
  bottomNav.querySelector('[data-tab="game"]').addEventListener('click', () => onGame?.());
  ...
  el.showGame = () => {
    el.classList.remove('sidebar--calls');
    for (const tab of bottomNav.querySelectorAll('.sidebar-bottom-tab')) tab.classList.toggle('active', tab.dataset.tab === 'game');
  };
  ...
  function toggleSidebarMenu() {
    ...
    const items = [
      ...
      { label: `Sobre ${BRAND_NAME}`, action: onAbout, enabled: !!onAbout },
    ];
